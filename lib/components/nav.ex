defmodule AwesomeDash.Component.Nav do
  ...
  def init(current_scene, opts) do
    ...
    graph =
      ...
      |> dropdown(
        {[
           {"Sensor", AwesomeDash.Scene.Sensor},
           {"Sensor (spec)", AwesomeDash.Scene.SensorSpec},
           {"Primitives", AwesomeDash.Scene.Primitives},
           {"Components", AwesomeDash.Scene.Components},
           {"Transforms", AwesomeDash.Scene.Transforms}
         ], current_scene},
        id: :nav,
        translate: {70, 15}
      )
